...
function Home() {
  ...
  <div className='relative z-10 '>
      ...
      <button className='flex gap-4 cursor-pointer hover:bg-amber-400 bg-amber-500 p-2 rounded-3xl' onClick={null}><span className='text-white text-3xl '>Explore Events</span><ArrowRight size={29} className='mt-2 text-white'/></button>
